...
http://api-v3.mojepanstwo.pl/bdl/series?metric_id=776

```{r, warning=FALSE, message=FALSE, eval=FALSE}
url <- "https://api-v3.mojepanstwo.pl/bdl/series?metric_id=776"
document <- rjson::fromJSON(file=url, method='C')
...
Wybirz jeden portal informacyjny. 
Sprawdź strukturę strony html.
Pobierz informacje o artykułach za pomocą pakietu `rvest`.
