...
https://api-v3.mojepanstwo.pl/dane/bdl_wskazniki?q=bezrobocie

```{r, warning=FALSE, message=FALSE, eval=FALSE}
url <- 'https://api-v3.mojepanstwo.pl/dane/bdl_wskazniki?q=bezrobocie'
document <- rjson::fromJSON(file=url, method='C')

tematy <- sapply(document[[1]], function(x) x$data$bdl_wskazniki.tytul)
kody <- sapply(document[[1]], function(x) x$data$bdl_wskazniki.id)
cbind(tematy, kody)
```
...
https://api-v3.mojepanstwo.pl/dane/bdl_wskazniki/776

```{r, warning=FALSE, message=FALSE, eval=FALSE}
url <- "https://api-v3.mojepanstwo.pl/dane/bdl_wskazniki/776"
document <- rjson::fromJSON(file=url, method='C')
