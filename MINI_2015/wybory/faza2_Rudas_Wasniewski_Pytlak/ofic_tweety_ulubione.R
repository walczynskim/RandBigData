...
ulubioneTweety <- function(katalog, data, data_pob, liczba){
...
#######################################################################
katalog1 <- "C:\\Dane\\Pawel_2\\PW\\R_Big_Data\\Projekt1\\tweety\\ulubione"
data1 <- "2015-02-07"
data_pob1 <- "data_poboru.txt"
liczba1 <- 900
ulubioneTweety(katalog1, data1, data_pob1, liczba1)

katalog2 <- "C:\\Dane\\Pawel_2\\PW\\R_Big_Data\\Projekt1\\tweety\\ulubione"
data2 <- "2015-03-30"
data_pob2 <- "data_poboru.txt"
liczba2 <- 100
ulubioneTweety(katalog2, data2, data_pob2, liczba2)
